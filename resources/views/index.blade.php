                                    ...
                                    <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns">
                                        ...
                                        <div class="product-cart-wrap">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <a aria-label="Quick view" class="action-btn " data-bs-toggle="modal"
                                                data-bs-target="#quickViewModal" id="{{$item->product_id}}" onclick="productView(this.id)" ><i class="fi-rs-eye"></i></a>
                                                <a aria-label="Quick view" class="btn w-100 hover-up" data-bs-toggle="modal"
                                                data-bs-target="#quickViewModal" id="{{$item->product_id}}" onclick="productView(this.id)" ><i
                        ...
                        <div class="product-list-small animated animated">
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="{{ route('product.details',$item->product_slug) }}"><img
                                            src="{{asset('uploads/product/'.$item->product_thumbnail)}}"
                                            alt="" /></a>
                                </figure>
